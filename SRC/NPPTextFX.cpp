...
{2,'Q',PLUGIN_NAME " Quick",NULL},
{1,'E',PLUGIN_NAME " Edit",NULL},
{1,'C',PLUGIN_NAME " Convert",NULL},
{1,'I',PLUGIN_NAME " Insert",NULL},
//{1,'H',PLUGIN_NAME " Online Help",NULL},
{1,'D',PLUGIN_NAME " HTML Tidy",NULL},
{1,'T',PLUGIN_NAME " Tools",NULL},
{2,'V',PLUGIN_NAME " Viz",NULL},
{1,'W',PLUGIN_NAME " Viz Settings",NULL},
{1,'S',PLUGIN_NAME " Settings",NULL},
};
...
{NPPTEXT("S:Visit Notepad++ && ") PLUGIN_NAME_MENU NPPTEXT(" website"),pfhNotepadweb,0,FALSE NPPPLUGINACCELERATOR(NULL)},
